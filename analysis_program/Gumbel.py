...
#ブロック伝搬時間の抽出(0.2MB:4~6s,0.5MB:4~7s,1MB:4~7s,10MB:10~30s,100MB:100~300s,1000MB:750~2750s) 
new_delay_list = []
...
gumbel_error = gumbel_error_tmp/len(count)
print('gumbel mean squared error:', gumbel_error)
#正規分布
p0 = [10, 1]
# p0 = [150, 30]#100MB
# p0 = [750, 150]#1000MB
...
normal_error = normal_error_tmp/len(count)
print('normal mean squared error:', normal_error)
#フレシェ分布
p0 = [1, 1, 1]
# p0 = [1, 150, 20]#100MB
# p0 = [1, 750, 100]#1000MB
...
frechet_error = frechet_error_tmp/len(count)
print('frechet mean squared error:', frechet_error)
#指数分布
p0 = [1]
# p0 = [0.10]#100MB
# p0 = [0.02]#1000MB
...
exponential_error = exponential_error_tmp/len(count)
print('exponential mean squared error:', exponential_error)
...
print('gumbel_AIC:', gumbel_aic)
print('frechet_AIC:', frechet_aic)
print('gumbel_BIC:', gumbel_bic)
print('frechet_BIC:', frechet_bic)
