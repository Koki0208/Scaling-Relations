...
x_values1 = [value * log(10) for value in x_values]
x_values2 = [value * log(100) for value in x_values]
x_values3 = [value * log(1000) for value in x_values]
x_values4 = [value * log(10000) for value in x_values]
