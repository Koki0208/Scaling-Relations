...
if select == 1:
    # データセット(x_values...ブロックサイズ y_values_set(1,2,3,4)...平均ブロック伝搬時間 
    # y_values_set1...10node y_values_set2...100node y_values_set3...1000node y_values_set4...10000node)
...
if select == 2:
    # データセット(x_values...ブロックサイズ y_values_set(1,2,3,4)...フォーク確率 
    # y_values_set1...10node y_values_set2...100node y_values_set3...1000node y_values_set4...10000node)
    x_values = [0.2, 0.5, 1, 10, 100, 1000]
